package xyz.faewulf.diversity_better_bundle.enchant;
...
public class VacuumEnchantment extends Enchantment implements ICustomEnchantCategory {
    ...
    protected boolean checkCompatibility(Enchantment $$0) {
        return !($$0 instanceof SelectiveVacuumEnchantment);
    }
