...
public class Config {
    ...
    public static final String path = "config/diversity_better_bundle.toml";
    public static final String old_path = "config/diversity_better_bundle.json";

    public static final Class<?> configClass = ModConfigs.class;
    public static final String translatePath = "diversity_better_bundle.config.";
