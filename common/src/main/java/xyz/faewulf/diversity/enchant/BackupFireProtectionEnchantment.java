...
public class BackupFireProtectionEnchantment extends Enchantment {

    public final BackupFireProtectionEnchantment.Type type;

    public BackupFireProtectionEnchantment() {
        super(Enchantment.Rarity.UNCOMMON, EnchantmentCategory.ARMOR, ARMOR_SLOTS);
        this.type = Type.FIRE;
    }
    ...
    public boolean checkCompatibility(@NotNull Enchantment $$0) {
        ...
        if ($$0 instanceof BackupFireProtectionEnchantment $$1) {
