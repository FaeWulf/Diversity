...
public class BackupProtectionEnchantment extends Enchantment {

    public final BackupProtectionEnchantment.Type type;

    public BackupProtectionEnchantment() {
        super(Enchantment.Rarity.COMMON, EnchantmentCategory.ARMOR, ARMOR_SLOTS);
        this.type = Type.ALL;
    }
    ...
    public boolean checkCompatibility(@NotNull Enchantment $$0) {
        ...
        if ($$0 instanceof BackupProtectionEnchantment $$1) {
