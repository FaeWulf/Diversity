...
public class BackupBlastProtectionEnchantment extends Enchantment {

    public final BackupBlastProtectionEnchantment.Type type;

    public BackupBlastProtectionEnchantment() {
    ...
    public boolean checkCompatibility(@NotNull Enchantment $$0) {
        ...
        if ($$0 instanceof BackupBlastProtectionEnchantment $$1) {
