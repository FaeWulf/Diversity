...
public class sneakThroughBerrybush {
    ...
    public void test(GameTestHelper helper) {
        ...
        helper.setBlock(4, 2, 6, Blocks.SWEET_BERRY_BUSH.defaultBlockState().setValue(BlockStateProperties.AGE_3, 3));
        helper.setBlock(4, 2, 2, Blocks.SWEET_BERRY_BUSH.defaultBlockState().setValue(BlockStateProperties.AGE_3, 3));

        Player player_sneak = helper.makeMockSurvivalPlayer();
        Player player_armored = helper.makeMockSurvivalPlayer();

        helper.startSequence()
                .thenExecute(() -> {
                    player_sneak.setPos(new BlockPos(4, 2, 6).getCenter());
                ...
                .thenExecute(() -> {
                    player_sneak.move(MoverType.PLAYER, new BlockPos(1, 2, 6).getCenter());
                })
