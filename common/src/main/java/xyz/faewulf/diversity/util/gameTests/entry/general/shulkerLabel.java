...
public class shulkerLabel {
    ...
    public void test(GameTestHelper helper) {
        ...
        itemStack.setHoverName(Component.literal("test"));
        ...
        helper.startSequence()
                ...
                .thenExecuteAfter(20, () -> {
                    List<Display.TextDisplay> textDisplays = helper.getEntities(EntityType.TEXT_DISPLAY, new BlockPos(4, 4, 4), 5);
                ...
                .thenExecute(() -> {
                    helper.setBlock(4, 2, 4, Blocks.AIR);
                })
                .thenExecuteAfter(20, () -> {
                    List<Display.TextDisplay> textDisplays = helper.getEntities(EntityType.TEXT_DISPLAY, new BlockPos(4, 4, 4), 5);
