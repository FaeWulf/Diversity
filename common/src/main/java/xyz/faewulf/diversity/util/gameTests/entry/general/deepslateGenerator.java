...
public class deepslateGenerator {
    ...
    public void test_cobble(GameTestHelper helper) {
        ...
        helper.setBlock(4, 3, 4, Blocks.LAVA);
        ...
        helper.runAfterDelay(20 * 5, () -> {
            helper.succeedIf(() -> {
                helper.assertBlockPresent(Blocks.COBBLESTONE, new BlockPos(1, 1, 1));
    ...
    public void test_deepslate(GameTestHelper helper) {
        ...
        helper.runAfterDelay(20 * 5, () -> {
            helper.succeedIf(() -> {
                helper.assertBlockPresent(Blocks.COBBLED_DEEPSLATE, new BlockPos(1, 1, 1));
                helper.assertBlockPresent(Blocks.DEEPSLATE, new BlockPos(4, 1, 4));
            });
        });
    }
}
