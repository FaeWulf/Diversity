package xyz.faewulf.diversity.mixin.general.noLevelLimitAnvil;
...
public class AnvilBlockMixin {
    ...
    @ModifyExpressionValue(method = {"createResult", "createResultInternal"}, at = @At(value = "CONSTANT", args = "intValue=40", ordinal = 2))
