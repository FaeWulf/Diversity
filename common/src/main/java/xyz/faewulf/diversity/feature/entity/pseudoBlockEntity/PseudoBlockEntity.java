...
public interface PseudoBlockEntity {
    ...
    /**
     * Checks if a block entity of type {@link EntityTypes#TEXT_DISPLAY} already exists within a small
     ...
     * {@link EntityTypes#TEXT_DISPLAY} within that box. If any such entities are found, the method
     * returns {@code true}, indicating that a block entity already exists in the vicinity.</p>
     *
     * @return {@code true} if a block entity of type {@link EntityTypes#TEXT_DISPLAY} is found
